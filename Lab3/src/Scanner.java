...
public class Scanner {
    ...
    public void scan() throws IOException {
        ...
        FileWriter stWriter = new FileWriter("C:\\Users\\16112001\\IdeaProjects\\FLCD\\Lab3\\ST.out");
        stWriter.write("ST implemented using hash table\n\n");
        stWriter.write(st.toString());
        stWriter.close();
        FileWriter pifWriter = new FileWriter("C:\\Users\\16112001\\IdeaProjects\\FLCD\\Lab3\\PIF.out");
        pifWriter.write("");
